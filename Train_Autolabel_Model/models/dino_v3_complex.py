...
# TODO: Try to use the register token in some way !!!!!!!!!!!!!!
# Try something like this:        
# global_context = registers.mean(dim=1, keepdim=True)  # (B, 1, C)
# embeddings = embeddings + global_context.expand(-1, num_tokens, -1)
...
class Dinov3WithComplexHead(nn.Module):
    def __init__(self, backbone: nn.Module, hidden_size: int, num_classes: int):
        super(Dinov3WithComplexHead, self).__init__()
